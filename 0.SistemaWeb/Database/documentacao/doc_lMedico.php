...
function testeUpdatePorParametro(){
    ...
    print_r($oMedico->updateMedicoCompleto("M0000", "Teste Update por Parametro",null,"marlon1",null,null,null,null,null,"template@teste.com"));
    // print_r($oMedico->insertMedicoCompleto("Teste1", "1234567","marlon1", "Pediatria", "Unimed", "1993-05-31", "Rua 7", "539879878888", "teste@email.com"));
