...
/**
 * The DefaultGreaterThanMatchmaker evaluates to true if all Property values are greater than the comparison value.
 *
 * @author Martin Planer
 */
public final class DefaultAllGreaterThanMatchmaker extends AbstractDefaultValuePropertyMatchmaker {

    private final NativeProperty property;
    private final Comparable<?> value;

    /**
     * Create a new DefaultAllGreaterThanMatchmaker.
     *
     * @param matchmaker
     *            to base on
     * @param filter
     */
    public DefaultAllGreaterThanMatchmaker(final AllGreaterThanMatchmaker matchmaker, final NativeFilter filter) {
