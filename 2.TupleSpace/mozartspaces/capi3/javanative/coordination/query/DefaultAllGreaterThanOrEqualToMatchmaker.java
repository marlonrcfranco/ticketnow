...
/**
 * The DefaultAllGreaterThanOrEqualToMatchmaker evaluates to true if all Property values are greater than or equal to
 * the comparison value.
 *
 * @author Martin Planer
 */
public final class DefaultAllGreaterThanOrEqualToMatchmaker extends AbstractDefaultValuePropertyMatchmaker {

    private final NativeProperty property;
    private final Comparable<?> value;

    /**
     * Create a new DefaultAllGreaterThanOrEqualToMatchmaker.
     *
     * @param matchmaker
     *            to base on
     * @param filter
     */
    public DefaultAllGreaterThanOrEqualToMatchmaker(final AllGreaterThanOrEqualToMatchmaker matchmaker,
