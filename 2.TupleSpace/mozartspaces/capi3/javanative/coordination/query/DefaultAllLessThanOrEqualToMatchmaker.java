...
/**
 * The DefaultAllLessThanOrEqualToMatchmaker evaluates to true if all Property values are less than or equal to the
 * comparison value.
 *
 * @author Martin Planer
 */
public final class DefaultAllLessThanOrEqualToMatchmaker extends AbstractDefaultValuePropertyMatchmaker {
     ...
     * @param filter
     */
    public DefaultAllLessThanOrEqualToMatchmaker(final AllLessThanOrEqualToMatchmaker matchmaker,
