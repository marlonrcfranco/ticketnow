...
/**
 * The DefaultLessThanMatchmaker evaluates to true if the Property is less than the value.
 *
 * @author Martin Barisits
 */
public final class DefaultLessThanMatchmaker extends AbstractDefaultValuePropertyMatchmaker {
     ...
     * @param filter
     */
    public DefaultLessThanMatchmaker(final LessThanMatchmaker matchmaker, final NativeFilter filter) {
    ...
    public boolean evaluate(final Serializable entry) {
        ...
        if ((Comparable.class.isAssignableFrom(propertyValue.getClass()))
            ...
            int compare;
            compare = (((Comparable<Object>) propertyValue).compareTo(currentValue));
