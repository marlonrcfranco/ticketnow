...
/**
 * Thrown when a container is locked by another transaction.
 * TODO add method to parse exception from its message (for generic serialization)
 *
 * @author Martin Barisits
 * @author Tobias Doenz
 */
public final class ContainerLockedException extends Capi3Exception {
     ...
     *            long-term lock
     */
    public ContainerLockedException(final String txId, final String stxId) {
        super("The container is locked by TX " + txId + " (Sub-TX " + stxId + ")");
        this.txId = txId;
        this.stxId = stxId;
    }
    ...
    private ContainerLockedException() {
        this.txId = null;
        this.stxId = null;
    }
