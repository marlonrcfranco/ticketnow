...
/**
 * Log Item for a Write Operation.
 *
 * @author Martin Barisits
 * @author Tobias Doenz
 */
public final class DefaultWriteLogItem extends DefaultLogItem {
     ...
     */
    public DefaultWriteLogItem(final NativeEntry entry, final LocalContainerReference cRef,
    ...
    public void commitSubTransaction() {
        if (entry != null) {
            getIsolationManager().releaseSubTransactionEntryLock(OperationType.WRITE, this.entry, getSubTransaction());
        }
    }
    ...
    public void commitTransaction() {
        if (entry != null) {
            getIsolationManager().releaseEntryLock(OperationType.WRITE, this.entry,
