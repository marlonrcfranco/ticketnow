...
/**
 * A <code>Request</code> to read entries from a container.
 *
 * @author Tobias Doenz
 *
 * @param <T>
 ...
 */
@ThreadSafe
public final class ReadEntriesRequest<T extends Serializable> extends SelectingEntriesRequest<ArrayList<T>> {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a <code>ReadEntriesRequest</code>. Consider to use a
     * {@link #withContainer(ContainerReference) Builder}.
     *
     * @param container
     *            the reference of the container where entries should be read
     * @param selectors
     ...
     *            the request context
     */
    public ReadEntriesRequest(final ContainerReference container, final List<? extends Selector> selectors,
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ReadEntriesRequest<?>)) {
            return false;
        }
        ReadEntriesRequest<?> other = (ReadEntriesRequest<?>) obj;
        // from superclasses
    ...
    public String toString() {
        return "ReadEntriesRequest [container=" + getContainer() + ", selectors=" + getSelectors() + ", timeout="
    ...
    /**
     * A class that helps to build a <code>ReadEntriesRequest</code>.
     *
     * @author Tobias Doenz
     *
     * @param <T>
    ...
    public static final class Builder<T extends Serializable> extends
            SelectingEntriesRequest.Builder<ReadEntriesRequest.Builder<T>, ReadEntriesRequest<T>> {

        /**
         * Protected constructor, use the static factory method
         * {@link ReadEntriesRequest#withContainer(ContainerReference)}.
         */
        ...
        @Override
        public ReadEntriesRequest<T> build() {
            return new ReadEntriesRequest<T>(getContainer(), getSelectors(), getTimeout(), getTransaction(),
