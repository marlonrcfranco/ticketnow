...
/**
 * A <code>Request</code> to test for entry existence in a container.
 *
 * @author Tobias Doenz
 */
@ThreadSafe
public final class TestEntriesRequest extends SelectingEntriesRequest<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a <code>TestEntriesRequest</code>. Consider to use a
     * {@link #withContainer(ContainerReference) Builder}.
     *
     * @param container
     *            the reference of the container where entries should be tested for
     * @param selectors
     ...
     *            the request context
     */
    public TestEntriesRequest(final ContainerReference container, final List<? extends Selector> selectors,
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof TestEntriesRequest)) {
            return false;
        }
        TestEntriesRequest other = (TestEntriesRequest) obj;
        // from superclasses
     ...
     *            tested for. This parameter must not be <code>null</code>.
    ...
    /**
     * A class that helps to build a <code>TestEntriesRequest</code>.
     *
     * @author Tobias Doenz
     */
    public static final class Builder extends
            SelectingEntriesRequest.Builder<TestEntriesRequest.Builder, TestEntriesRequest> {

        /**
         * Protected constructor, use the static factory method
         * {@link TestEntriesRequest#withContainer(ContainerReference)}.
         */
        ...
        @Override
        public TestEntriesRequest build() {
            return new TestEntriesRequest(getContainer(), getSelectors(), getTimeout(), getTransaction(),
